...
// Init code for WaveShare S3 Smart86 480x480 4" (From WaveShare github)
static const uint8_t st7701_type10_init_operations[] = {
    ...
    WRITE_C8_D8, 0xB0, 0x60, // Vop=4.7375v
    WRITE_C8_D8, 0xB1, 0x30, // VCOM=32 (was 0x32)
    WRITE_C8_D8, 0xB2, 0x87, // VGH=15v (was 0x07)
    WRITE_C8_D8, 0xB3, 0x80,
    WRITE_C8_D8, 0xB5, 0x49, // VGL=-10.17v
    WRITE_C8_D8, 0xB7, 0x85,
    WRITE_C8_D8, 0xB8, 0x21, // AVDD=6.6 & AVCL=-4.6
    ...
    //-----------VAP & VAN---------------
    WRITE_COMMAND_8, 0xFF,
    WRITE_BYTES, 5, 0x77, 0x01, 0x00, 0x00, 0x00, // 5th was 0x13

    // WRITE_C8_D8, 0xE5, 0xE4, // commented out by WaveShare

    // WRITE_COMMAND_8, 0xFF,
    // WRITE_BYTES, 5, 0x77, 0x01, 0x00, 0x00, 0x00, // Not in Waveshare init

	WRITE_C8_D8, 0x36, 0x00, // Added by Waveshare
